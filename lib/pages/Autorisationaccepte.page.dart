...
class AutorisationacceptePage extends StatefulWidget {
  @override
  _AutorisationacceptePageState createState() =>
      _AutorisationacceptePageState();
}

class _AutorisationacceptePageState extends State<AutorisationacceptePage> {
  ...
  Future<void> _fetchListConge() async {
    ...
    final url = Uri.parse(
        'https://localhost:44367/api/Autorisation/GetAutorisationAccepterByIdE?matricule=${prefs.getString('MATREmployee')}');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      drawer: MyDrawer(),
      appBar: AppBar(
        title: Text("Liste des Autorisations acceptées"),
      ),
