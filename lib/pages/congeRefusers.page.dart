...
class CongeRefusersPage extends StatefulWidget {
  @override
  _CongeRefusersPageState createState() => _CongeRefusersPageState();
}

class _CongeRefusersPageState extends State<CongeRefusersPage> {
  ...
  Future<void> _fetchListConge() async {
    ...
    final url = Uri.parse(
        'https://localhost:44367/api/MajCoge/GetCongesRefuserByIdE?matricule=${prefs.getString('MATREmployee')}');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      drawer: MyDrawer(),
      appBar: AppBar(
        title: Text("Liste des congés Refusés"),
      ),
